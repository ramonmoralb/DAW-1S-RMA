...
public class CuaInicial {
    ...
    public void afegirVehicle(Vehicle vehicle) {                        /*nuevoArray cada vez que se usa el metodo*/
    ...
    vehicles = nuevoArray;
    System.out.println("El "+vehicle+" S'ha afegit a la cua icicial en la posició: "+(vehicles.length));   
    System.out.println("---------------------------------------------------------");
    }
    public Vehicle traure(){
        Vehicle vehiculoExtraido=vehicles[0];
        // System.out.println("longitud vehicles antes del arrays.copyOF"+vehicles.length); // comprobacion interna
